package com.example.dasentregaindividual2.servidor.base_de_datos.tokenFCM;
...
public class AñadirToken extends Worker {

    public AñadirToken(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            ...
            String fcmToken = getInputData().getString("fcmToken");
            String opcion = "1";
