...
public class CambiarFotoDePerfil extends Worker {

    public CambiarFotoDePerfil(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            ...
            String fotoPerfilBase64 = getInputData().getString("fotoPerfilBase64");
            String opcion = "4";
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("nombreUsuario", nombreUsuario)
                    .appendQueryParameter("fotoPerfilBase64", fotoPerfilBase64)
